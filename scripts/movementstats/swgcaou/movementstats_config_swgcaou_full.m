...
% paralist.runlist = '/Volumes/menon/projects/daelsaid/2019_met/data/subjectlist/run_list.txt';

% I/O parameters
% - Raw data directory
% paralist.rawdatadir = '/Volumes/menon/rawdata/scsnl/';
...
% paralist.projectdir = '/Volumes/menon/projects/daelsaid/2019_met';


% Please specify the foler for preprocessed data via standard pipeline
paralist.preprocessed_folder    = 'swgcaou_spm12';
