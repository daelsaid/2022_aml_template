...
paralist.runlist = '/oak/stanford/groups/menon/projects/daelsaid/2022_aml/data/subjectlist/symbolic1_redo_runlist.txt';
...
runconfig.outputfile='${projectdir}/data/imaging/participants/${pid}/visit${visit}/session${session}/fmri/symbolic1_redo/swgcaor_spm12/swgcaorI.nii.gz'
