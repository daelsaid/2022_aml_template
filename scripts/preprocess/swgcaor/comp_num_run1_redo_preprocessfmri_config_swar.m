...
paralist.runlist = '/oak/stanford/groups/menon/projects/daelsaid/2022_aml/data/subjectlist/comp_num_run1_redo_runlist.txt';
...
runconfig.outputfile='${projectdir}/data/imaging/participants/${pid}/visit${visit}/session${session}/fmri/comp_num_run1_redo/swgcaor_spm12/swgcaorI.nii.gz'
