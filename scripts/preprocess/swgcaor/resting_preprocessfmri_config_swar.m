...
%paralist.spgrsubjectlist='subjectlist_all_aml_2022.txt';
...
paralist.runlist = '/oak/stanford/groups/menon/projects/daelsaid/2022_aml/data/subjectlist/resting_runlist.txt';
paralist.pipeline = 'swgcaor';
paralist.outputdirname = 'swgcaor_spm12';
...
runconfig.overwrite='1';
runconfig.outputfile='${projectdir}/data/imaging/participants/${pid}/visit${visit}/session${session}/fmri/resting/swgcaor_spm12/swgcaorI.nii.gz'
