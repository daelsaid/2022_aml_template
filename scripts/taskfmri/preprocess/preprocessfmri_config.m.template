...
%-Subject list
paralist.subjectlist = '/oak/stanford/groups/menon/projects/ruiyuan/2018_preproc_fMRI/data/subjectlist/subjectlist.csv'
%---- example ----
%- PID, visit, session
%- 7014, 1 ,1 
...
paralist.projectdir = '/oak/stanford/groups/menon/projects/ruiyuan/2018_preproc_fMRI/'; % add "/" at the end of the path
%%% ----------example -------------------
