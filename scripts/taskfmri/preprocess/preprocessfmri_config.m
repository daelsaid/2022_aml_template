...
paralist.projectdir = '/oak/stanford/groups/menon/projects/daelsaid/2019_met/'; % add "/" at the end of the path
%%% ----------example -------------------
...
%'/oak/stanford/groups/menon/projects/daelsaid/2019_met/data/subjectlist/spgrsubjectlist.csv';
