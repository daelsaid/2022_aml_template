...
scriptdir<-getwd()
setwd(dir="/oak/stanford/groups/menon/daelsaid/2019_met/data/imaging/participants")
dir<-getwd()
...
setwd(dir)
setwd(dir = paste(subject[1],'/visit',visit[1],'/session',session[1],'/fmri/',run[1],'/swar_spm12',sep=""))

for (i in 1:length(subject)){
setwd(dir = paste("../../../../../../",subject[i],'/visit',visit[i],'/session',session[i],'/fmri/',run[i],'/swar_spm12',sep=""))
filepath<-getwd()
